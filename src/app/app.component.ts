...
import {OEEfactors} from './oeeFactors';
import {OEEvariable} from './oeeVariables';
...
export class AppComponent {
  ...
  calculateOverallFactors(){
    ...
    this.dataArr= {data: [this.oeeFactors.availability*100,this.oeeFactors.performance*100,this.oeeFactors.quality*100,this.oeeFactors.overallOEE*100],
